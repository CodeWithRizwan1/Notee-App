...
import com.dev.noteeapp.databinding.BottomSheetLayoutBinding
import com.dev.noteeapp.databinding.FragmentSaveOrDeleteBinding
        ...
        if (contentBinding.etNoteContent.text.toString().isEmpty() ||
            ...
            when (note) {
                null -> {
                    ...
                    // Log statement to check if the note is being saved
                    Log.d("SaveOrDeleteFragment", "Saving note: $newNote")

                    // Save the note using the ViewModel
                    noteActivityViewModel.saveNote(newNote)
                    noteActivityViewModel.updateNote(newNote)
